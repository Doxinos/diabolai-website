...
/* ------------------------------------------------------------------ */
/* CSS — Diagonal section transitions + keyframes                      */
/* ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ */
/* SECTION 1 — HERO (3×3 fallback grid + overlay copy)                 */
/* ------------------------------------------------------------------ */
const ContentHero = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => { if (window.scrollY > 50) setShowArrow(false); };
    ...
    >
      ...
      <div className="relative z-10 text-center px-6 max-w-3xl mx-auto">
        ...
        <h1 className="font-black leading-[0.92] tracking-[-0.04em] text-[clamp(48px,8vw,100px)] mb-8">
          <span className="ch-line1 block text-white">Content that scales with you.</span>
          <span className="ch-line2 block text-[rgba(255,255,255,0.40)]">Not a team of 10.</span>
        </h1>

        <p className="ch-body max-w-[520px] mx-auto text-[clamp(16px,1.3vw,20px)] leading-[1.65] text-[rgba(255,255,255,0.65)] mb-10">
          AI-generated videos, UGC-style ads, and cinematic hero commercials — produced faster and at a fraction of traditional costs.
        </p>

        <div className="ch-ctas flex flex-wrap gap-4 justify-center">
          <button className="flex items-center gap-2 rounded-full bg-white px-8 py-4 text-sm font-bold text-[#111111] hover:bg-[rgba(255,255,255,0.90)] transition-colors duration-200">
            See the work <ArrowRight size={16} />
          </button>
          <button className="rounded-full border border-[rgba(255,255,255,0.30)] bg-transparent px-8 py-4 text-sm font-bold text-white hover:bg-[rgba(255,255,255,0.05)] transition-colors duration-200">
            Talk to us
          </button>
        </div>
      </div>
      ...
      {showArrow && (
        ...
        >
          <ChevronDown size={20} className="text-[rgba(255,255,255,0.40)]" />
        </div>
      )}
    </section>
  );
...
const TwoTracks = () => {
  ...
  return (
    <section ref={ref} className="diag-left w-full bg-[#DCDBD3] px-6 py-32 md:px-12" style={{ paddingBottom: '8rem' }}>
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="track-card rounded-2xl bg-white p-10 border border-[rgba(17,17,17,0.08)]">
            <p className="font-mono text-[11px] uppercase tracking-[0.14em] text-[#FF4F30] mb-4">Volume Track</p>
            ...
            <p className="text-[15px] leading-[1.65] text-[rgba(17,17,17,0.60)] mb-6">
              You need a constant stream of product videos, UGC-style ads, and social content. You can't afford a production team but you can't afford to go dark either.
            </p>
            <div className="space-y-2 mb-6">
              {['Product videos', 'UGC-style ad creatives (Meta, TikTok)', 'Social graphics + reels', 'Monthly content packages'].map((item) => (
                <div key={item} className="flex items-start gap-3">
                  <span className="font-mono text-[12px] text-[#FF4F30] mt-0.5 shrink-0">→</span>
                  <span className="font-mono text-[12px] leading-[1.6] text-[rgba(17,17,17,0.70)]">{item}</span>
                </div>
              ))}
            </div>
            ...
            <button className="w-full rounded-full bg-[#111111] px-8 py-3.5 text-sm font-semibold text-[#DCDBD3] hover:bg-[#222222] transition-colors duration-200">
              Get a Starter Pack
            </button>
          </div>
          ...
          <div className="track-card rounded-2xl bg-[#0A2843] p-10">
            <p className="font-mono text-[11px] uppercase tracking-[0.14em] text-[#FF4F30] mb-4">Hero Track</p>
            ...
            <p className="text-[15px] leading-[1.65] text-[rgba(255,255,255,0.65)] mb-6">
              You need a brand film that makes investors brag and competitors nervous. Cinematic concepts that couldn't exist any other way. 4–6 weeks, not 6 months.
            </p>
            <div className="space-y-2 mb-6">
              {['AI Hero Commercials', 'Campaign packages (3–5 connected films)', 'Concepts that couldn\'t be filmed traditionally', 'DaVinci Resolve color grade + sound design'].map((item) => (
                <div key={item} className="flex items-start gap-3">
                  <span className="font-mono text-[12px] text-[#FF4F30] mt-0.5 shrink-0">→</span>
                  <span className="font-mono text-[12px] leading-[1.6] text-[rgba(255,255,255,0.70)]">{item}</span>
                </div>
              ))}
            </div>
            ...
            <button className="w-full rounded-full bg-[#FF4F30] px-8 py-3.5 text-sm font-semibold text-white hover:bg-[#E64528] transition-colors duration-200">
              Discuss a project
            </button>
          </div>
        </div>
...
const VisualBreak2B = () => {
  ...
  return (
    <section ref={ref} className="relative w-full overflow-hidden" style={{ height: 'clamp(320px, 70vh, 800px)' }}>
      <div
        className="vb2b-img absolute inset-0"
        style={{
          backgroundImage: 'url(https://images.unsplash.com/photo-1620315808304-66597517ec1a?w=1600&q=80)',
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <span
          ...
          style={{ fontSize: 'clamp(80px,12vw,160px)', opacity: 0.08, letterSpacing: '-0.04em' }}
        >
          PROOF
        </span>
      </div>
...
const Portfolio = () => {
  ...
  const filters = ['All', 'Product Videos', 'UGC Ads', 'Social', 'Hero Commercials'];

  const tiles = [
    { id: 'IMG_PORT_01', category: 'Product Videos', aspect: '16/9', gradient: 'from-[#0A2843] to-[#111111]', label: 'PRODUCT VIDEO' },
    { id: 'IMG_PORT_02', category: 'UGC Ads', aspect: '9/16', gradient: 'from-[#1a0800] to-[#111111]', label: 'UGC AD · META' },
    { id: 'IMG_PORT_03', category: 'Hero Commercials', aspect: '16/9', gradient: 'from-[#0A2843] to-[#060e1a]', label: 'HERO COMMERCIAL' },
    { id: 'IMG_PORT_04', category: 'Social', aspect: '1/1', gradient: 'from-[#DCDBD3] to-[#aaa9a2]', label: 'SOCIAL REEL', darkLabel: true },
    { id: 'IMG_PORT_05', category: 'Product Videos', aspect: '4/3', gradient: 'from-[#0A2843] to-[#111111]', label: 'PRODUCT VIDEO' },
    { id: 'IMG_PORT_06', category: 'UGC Ads', aspect: '16/9', gradient: 'from-[#2a0800] to-[#111111]', label: 'UGC AD · TIKTOK' },
    { id: 'IMG_PORT_07', category: 'Social', aspect: '9/16', gradient: 'from-[#0A2843] to-[#111111]', label: 'SOCIAL · REEL' },
    { id: 'IMG_PORT_08', category: 'Hero Commercials', aspect: '16/9', gradient: 'from-[#111111] to-[#0A2843]', label: 'HERO COMMERCIAL' },
    { id: 'IMG_PORT_09', category: 'Product Videos', aspect: '1/1', gradient: 'from-[#0A2843] to-[#111111]', label: 'PRODUCT VIDEO' },
  ];
  ...
  const filteredTiles = activeFilter === 'All' ? tiles : tiles.filter((t) => t.category === activeFilter);

  return (
    <section ref={ref} className="diag-right w-full bg-white px-6 py-32 md:px-12" style={{ paddingBottom: '8rem' }}>
      <div className="mx-auto max-w-7xl">
        <div className="mb-12">
          <p className="font-mono text-[12px] uppercase tracking-[0.14em] text-[rgba(17,17,17,0.40)]">The Work</p>
          <h2 className="mt-4 text-[clamp(42px,6vw,72px)] font-black leading-[0.95] tracking-[-0.03em] text-[#111111]">
            See it. Then decide.
          </h2>
        </div>
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className={`font-mono text-[11px] uppercase tracking-[0.14em] ${
                  tile.darkLabel ? 'text-[rgba(17,17,17,0.25)]' : 'text-[rgba(255,255,255,0.25)]'
                }`}>
                  {tile.label}
                </span>
              </div>
...
const ThePipeline = () => {
  ...
  const stages = [
    ...
    { num: '02', title: 'Image Gen', line1: 'Midjourney', line2: 'prompt dev + approval' },
    { num: '03', title: 'Animate', line1: 'Kling + Veo3', line2: 'frame-by-frame motion' },
    { num: '04', title: 'Grade', line1: 'DaVinci', line2: 'Resolve color grade' },
    { num: '05', title: 'Deliver', line1: 'Files + MP4', line2: 'source assets' },
  ];
  ...
  return (
    <section ref={ref} className="diag-left w-full bg-[#DCDBD3] px-6 py-32 md:px-12" style={{ paddingBottom: '8rem' }}>
      <div className="mx-auto max-w-7xl">
        <div className="mb-16">
          <p className="font-mono text-[12px] uppercase tracking-[0.14em] text-[rgba(17,17,17,0.40)]">The Process</p>
          ...
          <p className="mt-4 text-[16px] leading-[1.65] text-[rgba(17,17,17,0.65)] max-w-[560px]">
            A professional production pipeline that happens to use AI. The difference shows.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 md:gap-4 mb-16">
          {stages.map((stage, i) => (
            <div key={stage.num} className="pipe-node flex flex-col items-center text-center relative">
              ...
              <p className="font-mono text-[11px] leading-[1.5] text-[rgba(17,17,17,0.50)]">{stage.line1}</p>
              <p className="font-mono text-[11px] leading-[1.5] text-[rgba(17,17,17,0.40)]">{stage.line2}</p>
            </div>
          ))}
        </div>
        ...
        <div className="pipe-callout mx-auto max-w-[680px] rounded-2xl bg-white p-6 md:p-8 border border-[rgba(17,17,17,0.08)]">
          <p className="font-mono text-[11px] uppercase tracking-[0.14em] text-[rgba(17,17,17,0.40)] mb-3">Key Distinction</p>
          <p className="text-[17px] leading-[1.65] text-[rgba(17,17,17,0.70)]">
            "We start from images — precise, approved, deliberate. Not from text prompts that produce something approximate. Every frame is designed before it moves. That's why it doesn't look like AI."
          </p>
        </div>
      </div>
    </section>
...
const VisualBreak4B = () => {
  return (
    <section className="relative w-full overflow-hidden" style={{ height: 'clamp(280px, 55vh, 650px)' }}>
      <div
        className="absolute inset-0"
        style={{
          backgroundImage: 'url(https://images.unsplash.com/photo-1611532736597-de2d4265fba3?w=1600&q=80)',
          backgroundSize: 'cover',
          backgroundPosition: 'center',
        }}
      />
      {/* Oxford Blue tint — signals the dark section coming next */}
      <div className="absolute inset-0" style={{ background: 'rgba(10, 40, 67, 0.45)' }} />
      <div className="absolute inset-0 flex items-center justify-center">
        <span
          className="font-black text-white select-none pointer-events-none"
          style={{ fontSize: 'clamp(80px,12vw,160px)', opacity: 0.07, letterSpacing: '-0.04em' }}
        >
          HERO
        </span>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="htd-el max-w-[480px]">
            <p className="text-[16px] leading-[1.7] text-[rgba(255,255,255,0.65)] mb-4">
              Traditional production has hard physical constraints — locations, actors, camera rigs, post schedules. Those constraints shape the creative. Creative shaped by constraints looks like everything else.
            </p>
            <p className="text-[16px] leading-[1.7] text-[rgba(255,255,255,0.65)]">
              We start from what the concept demands, not from what's physically available. The visual ceiling is genuinely different.
            </p>
          </div>
          ...
          <div className="htd-el rounded-2xl bg-[#060e1a] border border-[rgba(255,255,255,0.10)] p-8">
            {/* AI Hero Commercial */}
            <div className="mb-8">
              <p className="font-mono text-[11px] uppercase tracking-[0.14em] text-[rgba(255,255,255,0.40)] mb-2">One Film</p>
              <h3 className="text-[20px] font-bold text-white mb-2">Concept through delivery.</h3>
              <p className="text-[15px] text-[rgba(255,255,255,0.60)] mb-4">4–6 weeks. From $20,000.</p>
            ...
            <div className="border-t border-[rgba(255,255,255,0.10)] pt-8">
              <p className="font-mono text-[11px] uppercase tracking-[0.14em] text-[rgba(255,255,255,0.40)] mb-2">3–5 Connected Films</p>
              <h3 className="text-[20px] font-bold text-white mb-2">One visual world. Multiple pieces.</h3>
              <p className="text-[15px] text-[rgba(255,255,255,0.60)] mb-4">From $50,000.</p>
              <button className="rounded-full border border-[rgba(255,255,255,0.20)] px-6 py-3 text-sm font-semibold text-white hover:bg-[rgba(255,255,255,0.05)] transition-colors duration-200">
                Discuss this project
              </button>
            </div>
          ...
          <div className="obj-el">
            <div className="space-y-4 lg:pt-20">
              <p className="text-[18px] leading-[1.7] text-[rgba(17,17,17,0.70)]">
                The "AI-looking" problem comes from text-to-video: describe something, get a rough approximation, call it done.
              </p>
              <p className="text-[18px] leading-[1.7] text-[rgba(17,17,17,0.70)]">
                Our pipeline starts from image generation — where creative control is precise — and animates from there. Every visual decision is made before motion is added. You approve frames before a single pixel moves.
              </p>
              <p className="text-[18px] leading-[1.7] text-[rgba(17,17,17,0.70)]">
                If you've seen AI video that looked unfinished or strange, it was made differently.
              </p>
            </div>

            <div className="mt-8">
              <button className="inline-flex items-center gap-2 text-[15px] font-semibold text-[rgba(17,17,17,0.70)] hover:text-[#111111] transition-colors duration-200">
      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="fcta-card rounded-2xl bg-white p-10 border border-[rgba(17,17,17,0.08)]">
            <p className="font-mono text-[11px] uppercase tracking-[0.14em] text-[#FF4F30] mb-4">Volume Track</p>
            <h3 className="text-[22px] font-extrabold text-[#111111] mb-3">Ready to start?</h3>
            <p className="text-[15px] leading-[1.65] text-[rgba(17,17,17,0.60)] mb-4">
              Get your first 5–10 AI content pieces in 2 weeks. No long onboarding.
            </p>
            <p className="font-mono text-[13px] text-[rgba(17,17,17,0.50)] mb-6">From €1,000</p>
            <button className="w-full rounded-full bg-[#111111] px-8 py-3.5 text-sm font-semibold text-[#DCDBD3] hover:bg-[#222222] transition-colors duration-200">
              Get a Starter Pack
            </button>
          </div>
          ...
          <div className="fcta-card rounded-2xl bg-[#0A2843] p-10">
            <p className="font-mono text-[11px] uppercase tracking-[0.14em] text-[#FF4F30] mb-4">Hero Track</p>
            <h3 className="text-[22px] font-extrabold text-white mb-3">Have a project in mind?</h3>
            <p className="text-[15px] leading-[1.65] text-[rgba(255,255,255,0.65)] mb-4">
              Tell us what you're building. We'll tell you if we can make it.
            </p>
            <p className="font-mono text-[11px] uppercase tracking-[0.14em] text-[rgba(255,255,255,0.40)] mb-6">
              30-min call · No pitch deck · No proposals until we know it's a fit
            </p>
            <button className="w-full rounded-full bg-[#FF4F30] px-8 py-3.5 text-sm font-semibold text-white hover:bg-[#E64528] transition-colors duration-200">
              Discuss a project
            </button>
