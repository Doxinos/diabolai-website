...
const HeroPanels = () => {
  ...
  return (
    <section ref={ref} data-theme="dark" className="relative overflow-hidden">
      <div
        className="ah-panels flex flex-col lg:flex-row w-full"
      ...
      >
        ...
        <div className="relative flex-1 bg-[#0d0d0d] flex items-center justify-center p-8 lg:p-12 min-h-[250px] lg:min-h-0">
          ...
          <div className="relative rounded-2xl overflow-hidden w-full max-w-xs aspect-[3/4]">
            <img
              src="/img-avatar-demo.png"
              alt="Real person on camera"
    ...
    <section ref={ref} className="w-full bg-[#DCDBD3] px-6 py-20 lg:py-28 md:px-12">
      <div className="mx-auto max-w-[680px] text-center">
        ...
        <p className="hc-body max-w-[480px] mx-auto text-[18px] leading-[1.65] text-[rgba(17,17,17,0.65)] mt-6 mb-10">
          Your AI avatar speaks in your voice, moves like you, and shows up
          consistently — so your business stays visible while you focus on the
          work that matters.
        </p>
        <div className="hc-ctas flex flex-wrap gap-4 justify-center">
          <button
            onClick={onBookCall}
            className="btn-magnetic flex items-center gap-2 rounded-full bg-[#111111] px-8 py-4 text-sm font-bold text-[#DCDBD3] hover:bg-[#222222]"
          >
            See a Demo <Play size={14} />
          </button>
          <button
            onClick={onBookCall}
            className="btn-magnetic rounded-full border border-[rgba(17,17,17,0.20)] bg-transparent px-8 py-4 text-sm font-bold text-[#111111] hover:bg-[rgba(17,17,17,0.04)]"
          >
            Build My Avatar
          </button>
        </div>
...
const AvatarHero = ({ onBookCall }: { onBookCall: () => void }) => (
  <>
    <HeroPanels />
    <HeroCopy onBookCall={onBookCall} />
  </>
)
...
const WhatItIs = ({
  ...
  const canDo: Array<string | { main: string; sub: string }> = [
    ...
    {
      main: 'Handle live Q&A and real-time conversations',
      sub: '(Interactive Avatar \u2014 advanced setup, see below)',
    },
  ]
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-0 mb-16">
              ...
              {canDo.map((item, i) => {
                ...
                return (
                  <div key={i} className="flex items-start gap-3">
                    <span className="font-mono text-[13px] text-[#FF4F30] mt-0.5 shrink-0">
                      &rarr;
                    </span>
                    <span className="font-mono text-[13px] leading-[1.6] text-[rgba(17,17,17,0.70)]">
                      {main}
                      {sub && (
                        <span className="block text-[11px] text-[rgba(17,17,17,0.40)] mt-0.5">
                          {sub}
                        </span>
                      )}
                    </span>
          ...
          <div className="wit-col md:pl-10 pt-8 md:pt-0">
            <h3 className="text-lg font-bold text-[rgba(17,17,17,0.50)] mb-6">
              It can&apos;t
            </h3>
            <div className="space-y-3">
              {cantDo.map((item) => (
                <div key={item} className="flex items-start gap-3">
                  <span className="font-mono text-[13px] text-[rgba(17,17,17,0.35)] mt-0.5 shrink-0">
                    &times;
                  </span>
                  <span className="font-mono text-[13px] leading-[1.6] text-[rgba(17,17,17,0.40)]">
                    {item}
                  </span>
                </div>
              ))}
        ...
        <div className="wit-callout mx-auto max-w-[640px] rounded-2xl bg-white p-6 md:p-8 border border-[rgba(17,17,17,0.08)]">
          <p className="text-[17px] leading-[1.65] text-[rgba(17,17,17,0.65)] text-center">
            &ldquo;The goal isn&apos;t to replace you. It&apos;s to multiply
            you. One recording session gives you an unlimited supply of
            professional video content. That&apos;s the leverage.&rdquo;
          </p>
        </div>
        ...
        <div className="wit-callout mx-auto max-w-[640px] rounded-2xl bg-[#0A2843] p-8 border border-[rgba(255,255,255,0.10)] mt-6">
          <p className="font-mono text-[11px] uppercase tracking-[0.14em] text-[#FF4F30] mb-3">
            Advanced &middot; Interactive Avatar
          </p>
          ...
          <p className="text-[15px] leading-[1.65] text-[rgba(255,255,255,0.65)] mb-5">
            Interactive Avatar goes further than pre-scripted video. Your
            digital twin can hold real-time conversations — answering questions,
            walking visitors through your services, qualifying leads — live, on
            demand, 24/7. Same face. Same voice. No script required.
          </p>
          <div className="space-y-2 mb-6">
            <div className="flex items-start gap-3">
              <span className="font-mono text-[12px] text-[rgba(255,255,255,0.60)] mt-0.5 shrink-0">
                &rarr;
              </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="uc-card rounded-2xl bg-[#DCDBD3] p-8">
            ...
            <p className="text-sm leading-[1.65] text-[rgba(17,17,17,0.60)] mb-6">
              Your avatar delivers your LinkedIn or YouTube content — consistent,
              on-brand, on time. Record a script, approve the output, publish.
            </p>
            ...
            <div className="rounded-xl bg-[#111111] p-4 flex items-center gap-3">
              ...
              <span className="font-mono text-[10px] uppercase tracking-[0.12em] text-[rgba(255,255,255,0.50)]">
                Weekly Post &middot; 2 min &middot; Published
              </span>
            </div>
          </div>
          ...
          <div className="uc-card rounded-2xl bg-[#DCDBD3] p-8">
            ...
            <p className="text-sm leading-[1.65] text-[rgba(17,17,17,0.60)] mb-6">
              Every service you offer. Every product you launch. Explained
              professionally by you — without you being on set for each one.
            </p>
            {/* Mini visual — stacked thumbnail tiles */}
            <div className="space-y-2">
              {['Product Video', 'Service Explainer', 'Case Study'].map(
                (label) => (
                  <div
                    key={label}
                  ...
                  >
                    <Video
                      size={12}
                      className="text-[rgba(17,17,17,0.30)]"
                    />
          ...
          <div className="uc-card rounded-2xl bg-[#DCDBD3] p-8">
            ...
            <p className="text-sm leading-[1.65] text-[rgba(17,17,17,0.60)] mb-6">
              Internal training, onboarding sequences, process walkthroughs —
              delivered by you, at any scale, without scheduling a recording
              session every time.
            </p>
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-0 items-start mb-16">
          {steps.map((step, i) => (
            <div
              key={step.num}
              className="sp-step flex md:flex-col items-start gap-5 md:px-6 relative"
            >
              {i < steps.length - 1 && (
                <span className="hidden md:block absolute top-5 -right-1 text-[rgba(255,255,255,0.20)] text-lg">
                  &rarr;
                </span>
              )}
              ...
              <div>
                ...
                <p className="text-sm leading-[1.65] text-[rgba(255,255,255,0.65)]">
                  {step.body}
                </p>
              </div>
            </div>
    ...
    <section ref={ref} className="w-full bg-[#DCDBD3] px-6 py-32 md:px-12">
      <div className="pwc-content mx-auto max-w-7xl">
        ...
        <p className="max-w-[560px] text-[16px] leading-[1.65] text-[rgba(17,17,17,0.65)] mb-12">
          The avatar gives you a presence. AI Content gives you volume. Together:
          your face and voice appear in every piece of content — product videos,
          ads, social posts, explainers — without you stepping in front of a
        ...
        <div className="flex flex-wrap items-center gap-4 md:gap-6 mb-12">
          ...
          <span className="text-xl font-bold text-[rgba(17,17,17,0.25)]">
            +
          </span>
...
const FinalCTA = ({
  ...
  return (
    <section
      ref={ref}
      data-theme="dark"
      className="w-full bg-[#111111] px-6 py-32 md:px-12"
    >
      <div className="afcta-content mx-auto max-w-xl text-center">
        ...
        <h2 className="text-[clamp(36px,5vw,60px)] font-black leading-[0.95] tracking-[-0.03em] mb-8">
          ...
          <span className="text-[#FF4F30] block mt-2">
            quality and consistency.
          </span>
        </h2>
        <p className="text-[16px] leading-[1.65] text-[rgba(255,255,255,0.60)] max-w-[480px] mx-auto mb-10">
          Book a 30-minute call. We&apos;ll show you a live demo, walk through
          what the setup looks like for your business, and answer every question
          before you commit to anything.
        </p>
        <div className="flex flex-wrap gap-4 justify-center">
          <button
            onClick={onBookCall}
            className="btn-magnetic rounded-full bg-white px-10 py-4 text-sm font-semibold text-[#111111] hover:bg-[rgba(255,255,255,0.90)]"
          >
            Book a Demo Call
          </button>
          <button
            onClick={onBookCall}
            className="btn-magnetic rounded-full border border-[rgba(255,255,255,0.20)] bg-transparent px-8 py-4 text-sm font-semibold text-white hover:bg-[rgba(255,255,255,0.05)]"
          >
            Build My Avatar
          </button>
        </div>
        <p className="mt-4 font-mono text-[11px] uppercase tracking-[0.14em] text-[rgba(255,255,255,0.30)]">
          No commitment &middot; 30 minutes &middot; Free demo
        </p>
      </div>
    </section>
  )
...
/* PAGE ASSEMBLY                                                       */
/* ------------------------------------------------------------------ */
export default function AIAvatarsClient() {
  const handleBookCall = useCallback(() => {
    trackScheduleClick('ai-avatars')
  ...
  return (
    <main className="relative w-full selection:bg-[#FF4F30] selection:text-white">
      <Navbar forceDark />
      <AvatarHero onBookCall={handleBookCall} />
      <WhatItIs onBookCall={handleBookCall} />
      <UseCases />
      <FullBleedBreak />
      <SetupProcess />
      <PairedWithContent />
