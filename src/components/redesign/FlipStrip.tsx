  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[#FF4F30] flex flex-col justify-center px-8 md:px-16 lg:px-20 gap-2 md:flex-row md:items-center md:gap-12 lg:gap-16">
        ...
        <Link
          href={tile.href}
          className="font-mono text-[11px] uppercase tracking-[0.18em] text-[rgba(17,17,17,0.55)] hover:text-[#111111] transition-colors duration-200 flex-shrink-0 self-start md:self-auto no-underline"
